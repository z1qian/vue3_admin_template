...
import type { UserRoleData, SetRoleData, PagedRolesResponse, Role } from './type'
...
// 获取分页的角色数据列表
export const reqGetPagedRoleList = (page: number, limit: number, roleName: string): Promise<PagedRolesResponse> =>
